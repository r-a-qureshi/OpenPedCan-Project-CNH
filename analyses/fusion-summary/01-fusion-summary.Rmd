...
embryFuses <- c(
  ...
  "MN1--BEND2",
  "MN1--CXXC5",
  "EWSR1--PLAGL1" # add the desired fusion to the embryonal tumor analysis
)
embryGenes <- c(
  "FOXR2",
  "MN1",
...
allFuseEmbry %>%
  ...
  # sort the columns to match the existing results file in the repo
  select(order(colnames(.))) %>%
  relocate(Kids_First_Biospecimen_ID) %>%
  write_tsv(embryFile)
```
